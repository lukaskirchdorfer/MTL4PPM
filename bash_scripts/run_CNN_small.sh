...
DATASETS=("BPI_Challenge_2012C.csv" "BPIC15_1.csv" "BPIC20_DomesticDeclarations.csv" "BPIC20_InternationalDeclarations.csv" "BPI_Challenge_2013_incidents.csv")
TASKS=("multi")
MODELS=("CNN")
MTL_METHODS=("EW" "DWA" "GLS" "RLW" "UW" "UW_O" "UW_SO" "IMTL" "Nash_MTL" "GradNorm" "GradDrop" "PCGrad" "CAGrad")
EPOCHS=200
